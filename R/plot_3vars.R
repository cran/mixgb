...
#' @description Plot observed values versus m sets of imputed values for two specified numeric variables and a factor using \pkg{ggplot2}.
...
#' @param con.fac The name of a factor to condition on
